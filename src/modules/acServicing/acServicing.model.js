...
const acServicingSchema = new mongoose.Schema(
    {
        name: {
            type: String,
        ...
        specialties: {
            type: [String],
            default: ['নতুন এসি ইনস্টলেশন ও আনইনস্টলেশন', 'এসি গ্যাস রিফিলিং ও লিক ফিক্স']
        },
        dailyWage: {
            type: Number,
            default: 0
...
const AcServicing = mongoose.models.AcServicing || mongoose.model('AcServicing', acServicingSchema);
